  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white">
      <div className="min-h-screen flex flex-row">
        <div className="flex-none w-1/3 p-3 bg-black rounded-lg my-5 ml-5">
          <div className="text-center">
            <div className="mt-2 flex items-center justify-center">
              <Settings2 className="text-gray-200" />
              <p className="text-gray-200 font-bold text-lg ml-2">
                Assistant Settings
              </p>
            </div>
          ...
          <Card className="bg-gray-900 border-none sm:p-8 rounded-md ">
            <CardContent>
              <CardTitle>
              ...
              <input
                ...
                className="mb-5 mt-3 p-2 border rounded-md w-full focus:outline-none focus:border-green-500 bg-opacity-50 text-gray-900"
                required
              />
              ...
              <CardTitle>
                <span className="text-sm my-3 text-white">
                  Max Pages to Crawl:
                </span>
              </CardTitle>
              <input
        ...
        <div className="flex-grow bg-black rounded-lg mx-5 my-5">
          <div className="mt-5 text-center">
            <div className="flex justify-center items-center space-x-3 rtl:space-x-reverse">
              <Camera className="text-gray-200" />
              <span className=" text-gray-200 text-lg font-bold whitespace-nowrap dark:text-white">
                Create New Assistant
              </span>
            </div>
            <span className="text-xs text-gray-400">
              {" "}
              Customize the look and feel of your assistant, provide details
              such as name, description, price and assistant image.{" "}
            </span>
          </div>
          <Card className="bg-gray-900 border-none sm:p-8 rounded-md">
            <CardContent>
            ...
            <CardFooter>
              <div className="flex items-center justify-center">
                <button
                  ...
                  {formLoading ? "Loading..." : "Create Assistants"}
                </button>
              </div>
            </CardFooter>
          </Card>
